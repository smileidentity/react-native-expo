...
with_node \
  ...
  --target "/Users/jumaallan/Workspace/SmileID/react-native-expo/example/ios/Pods/Target Support Files/Pods-reactnativeexpoexample/ExpoModulesProvider.swift" \
  --entitlement "/Users/jumaallan/Workspace/SmileID/react-native-expo/example/ios/reactnativeexpoexample/reactnativeexpoexample.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-keep-awake" "react-native-expo"
