...
class SmileIDSmartSelfieEnrollmentModule : Module() {
    ...
    override fun definition() = ModuleDefinition {
        ...
        // The module will be accessible from `requireNativeModule('SmileIDSmartSelfieEnrollment')` in JavaScript.
        Name("SmileIDSmartSelfieEnrollment")
